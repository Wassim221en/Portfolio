import { Quote, Star, Calendar, Building, MapPin, ExternalLink } from 'lucide-react';
...
export default function Recommendations() {
  ...
  const averageRating = recommendationsData.reduce((acc, rec) => acc + rec.rating, 0) / recommendationsData.length;
